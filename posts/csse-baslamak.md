...
[/sourcecode] HTML'de bu elementi(h1) kalın,altı çizili, ardalanı
...
[/sourcecode] Bunun gibi onlarca veya yüzlerce başlığınız olduğunu
düşünün, gerçekten çok zor. CSS'de aynı işlem için [sourcecode
language='css'] h1 {color: blue;} [/sourcecode]hatta daha sonra bu
...
[sourcecode language='css'] h1, h2 {color: blue;} [/sourcecode] Ayrıca
