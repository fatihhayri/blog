...
aşağıdaki kod yazıyordu. RewriteEngine On RewriteCond %{HTTP\_REFERER}
.\*google.\*\$ [NC,OR] RewriteCond %{HTTP\_REFERER} .\*aol.\*\$ [NC,OR]
RewriteCond %{HTTP\_REFERER} .\*msn.\*\$ [NC,OR] RewriteCond
%{HTTP\_REFERER} .\*altavista.\*\$ [NC,OR] RewriteCond %{HTTP\_REFERER}
.\*ask.\*\$ [NC,OR] RewriteCond %{HTTP\_REFERER} .\*yahoo.\*\$ [NC]
